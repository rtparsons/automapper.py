...
def test_pydantic_to_object_map(
...
def test_pydantic_to_object_map_missing_destination_field(
    source_pydantic: type,
...
def test_pydantic_to_object_map_extra_destination_field_not_set(
    source_pydantic: type,
...
def test_pydantic_to_object_map_extra_destination_field(
    source_pydantic: type,
    destination_object_with_more_fields: type,
) -> None:
    source = source_pydantic(a=1, b="test")
    mapper.add(source_pydantic, destination_object_with_more_fields, {"c": "b"})
...
def test_pydantic_to_object_map_extra_field_via_function_mapping(
    source_pydantic: type,
    destination_object_with_more_fields: type,
) -> None:
    source = source_pydantic(a=1, b="test")
...
def test_pydantic_to_object_map_nonexistent_source_field(
    source_pydantic: type,
    destination_object: type,
) -> None:
    source = source_pydantic(a=1, b="test")
...
def test_pydantic_to_object_map_nonexistent_destination_field(
    source_pydantic: type,
    destination_object: type,
) -> None:
    source = source_pydantic(a=1, b="test")
