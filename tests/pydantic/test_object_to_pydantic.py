...
def test_object_to_pydantic_map(
    source_object: type,
...
def test_object_to_pydantic_map_missing_destination_field(
    source_object: type,
...
def test_object_to_pydantic_map_extra_destination_field_not_set(
    source_object: type,
...
def test_object_to_pydantic_map_extra_destination_field(
    source_object: type,
    destination_pydantic_with_more_fields: type,
) -> None:
    source = source_object(a=1, b="test")
    mapper.add(source_object, destination_pydantic_with_more_fields, {"c": "b"})
...
def test_object_to_pydantic_map_extra_field_via_function_mapping(
    source_object: type,
    destination_pydantic_with_more_fields: type,
) -> None:
    source = source_object(a=1, b="test")
...
def test_object_to_pydantic_map_nonexistent_source_field(
    source_object: type,
    destination_pydantic: type,
) -> None:
    source = source_object(a=1, b="test")
...
def test_object_to_pydantic_map_nonexistent_destination_field(
    source_object: type,
    destination_pydantic: type,
) -> None:
    source = source_object(a=1, b="test")
