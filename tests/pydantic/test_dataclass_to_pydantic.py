...
def test_dataclass_to_pydantic_map(
...
def test_dataclass_to_pydantic_map_missing_destination_field(
    source_dataclass: type,
...
def test_dataclass_to_pydantic_map_extra_destination_field_not_set(
    source_dataclass: type,
...
def test_dataclass_to_pydantic_map_extra_destination_field(
    source_dataclass: type,
    destination_pydantic_with_more_fields: type,
) -> None:
    source = source_dataclass(a=1, b="test")
    mapper.add(source_dataclass, destination_pydantic_with_more_fields, {"c": "b"})
...
def test_dataclass_to_pydantic_map_extra_field_via_function_mapping(
    source_dataclass: type,
    destination_pydantic_with_more_fields: type,
) -> None:
    source = source_dataclass(a=1, b="test")
...
def test_dataclass_to_pydantic_map_nonexistent_source_field(
    source_dataclass: type,
    destination_pydantic: type,
) -> None:
    source = source_dataclass(a=1, b="test")
...
def test_dataclass_to_pydantic_map_nonexistent_destination_field(
    source_dataclass: type,
    destination_pydantic: type,
) -> None:
    source = source_dataclass(a=1, b="test")
